...
This project is indexed by GitNexus as **eve-sentry** (1976 symbols, 4041 relationships, 133 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
