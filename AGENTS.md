...
This project is indexed by GitNexus as **eve-sentry** (1268 symbols, 2430 relationships, 71 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
