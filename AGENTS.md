...
This project is indexed by GitNexus as **eve-sentry** (782 symbols, 1455 relationships, 40 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
