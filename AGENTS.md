...
This project is indexed by GitNexus as **eve-sentry** (1188 symbols, 2287 relationships, 66 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
