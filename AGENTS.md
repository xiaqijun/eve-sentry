...
This project is indexed by GitNexus as **eve-sentry** (2586 symbols, 5465 relationships, 185 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
