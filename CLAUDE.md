...
This project is indexed by GitNexus as **eve-sentry-esi-gateway** (135 symbols, 253 relationships, 8 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
