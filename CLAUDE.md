...
This project is indexed by GitNexus as **eve-sentry-esi-gateway** (146 symbols, 263 relationships, 8 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
