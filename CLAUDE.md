...
This project is indexed by GitNexus as **eve-sentry** (1343 symbols, 2608 relationships, 74 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
