...
This project is indexed by GitNexus as **eve-sentry** (1853 symbols, 3788 relationships, 128 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
